...
public class LogInThread extends Thread {
    ...
    public void run() {
        ...
        HttpPost httpPost = new HttpPost(ConstArgument.HTTP_URL + "LogInServlet");
        try {
            // Upload data
            JSONObject inputPack = new JSONObject();
            inputPack.put("username", username);
            inputPack.put("password", password);
