...
public class TrainHeartRateModelThread extends Thread {
    ...
    public void run() {
        ...
        System.out.println("Train heart-rate REQUEST");

        AndroidHttpClient androidHttpClient = AndroidHttpClient.newInstance("");
        HttpGet httpGet = new HttpGet(ConstArgument.HTTP_URL + "TrainHeartRateModelServlet" + "?id=" + id);
        try {
            // Request
        ...
        System.out.println("Train heart-rate END");
    }
}
