...
public class UpdateNicknameThread extends Thread {
    ...
    /*
     * @Constructor UpdateNicknameThread
     * @Param Handler handler
     */
    public UpdateNicknameThread(Handler handler) {
    ...
    public void run() {
        ...
        HttpPost httpPost = new HttpPost(ConstArgument.HTTP_URL + "UpdateNicknameServlet");
        try {
            // Upload data
            JSONObject inputPack = new JSONObject();
            inputPack.put("id", id);
            inputPack.put("nickname", nickname);
