...
public class UploadWeightThread extends Thread {
    ...
    /*
     * @Constructor UploadWeightThread
     * @Param Handler handler
     */
    public UploadWeightThread(Handler handler) {
    ...
    public void run() {
        ...
        HttpPost httpPost = new HttpPost(ConstArgument.HTTP_URL + "InsertWeightServlet");
        try {
            // Upload data
            JSONObject inputPack = new JSONObject();
            inputPack.put("id", id);
            inputPack.put("weight", weight);
